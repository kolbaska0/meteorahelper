...
class DLMM:
    ...
    def __init__(self, public_key: Pubkey, rpc: str, cluster: str) -> None:
        ...
        try:
            API_URL_SERVER = "https://meteorahelper.ru/api/v1/meteora"
            result = session.get(f"{API_URL_SERVER}/dlmm/create")
...
class DLMM_CLIENT:
    ...
    @staticmethod
    def create(public_key: Pubkey, rpc: str, cluster: str = "mainnet-beta") -> DLMM:
        '''
        ...
        return DLMM(public_key, rpc, cluster)
    
    @staticmethod
    def create_multiple(public_keys: List[Pubkey], rpc: str, cluster: str = "mainnet-beta") -> List[DLMM]:
        '''
        ...
        return [DLMM(public_keys, rpc, cluster) for public_keys in public_keys]
    
    @staticmethod
    def get_all_lb_pair_positions_by_user(user: Pubkey, rpc: str, cluster: str = "mainnet-beta") -> Dict[str, PositionInfo]:
        '''
    ...
    def check_health():
        try:
            result = requests.get(f"{API_URL}/").text
