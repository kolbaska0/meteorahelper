...
class PositionData():
    ...
    reward_two: str
    fee_owner: str
    total_claimed_fee_X_amount: str
    total_claimed_fee_Y_amount: str
...
class GetPositionByUser():
    ...
    def __init__(self, data: dict):
        ...
        if data.get("userPositions") is None:
            raise AttributeError("userPositions is required")
...
class LBPair:
    ...
    def __init__(self, data: dict) -> None:
        ...
        self.fee_owner = Pubkey.from_string(data["feeOwner"]) if data.get("feeOwner") else None
...
class TokenReserve():
    ...
    def __init__(self, data: dict) -> None:
        ...
        self.decimal = data["decimal"] if data.get("decimal") else data["mint"]["decimals"] if data.get("mint") else None
